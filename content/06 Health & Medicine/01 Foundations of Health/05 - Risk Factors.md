...
A **risk factor** is anything that makes a disease **more likely** to occur.

A risk factor is **not the disease itself**.
...
- Family history increases the risk of certain inherited diseases.
...
# Why do Risk Factors exist?

Disease rarely has a single cause.

Instead, disease usually develops through interactions between:
...
These can be reduced or changed.
...
External conditions that influence health.
...
Not all influences increase risk.

Some reduce disease probability.
...
Protective factors help maintain health and strengthen resilience.

---

# Multiple Risk Factors

Disease usually results from **multiple interacting risks**.
...
Reducing common risk factors lowers:
...
Modern medicine assesses risk using:
...
These tools estimate disease probability before symptoms develop.

---

## Philosophy

Risk factors teach an important principle:

> **Disease prevention begins long before disease appears.**

The choices made today shape the probabilities of tomorrow.
...
**Risk Factors** explains **why disease becomes more or less likely**.
